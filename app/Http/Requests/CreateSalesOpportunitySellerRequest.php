...
class CreateSalesOpportunitySellerRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'contact_number.*.required'   => 'El campo NUMERO DE TELEFONO es obligatorio.',
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            {
                $validator->errors()->add('phone', 'El campo TELEFONO o EMAIL deben ser completados.');
            }
